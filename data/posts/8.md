...
Instead of sitting back, the very next week, I introduced myself on the IRC channel `#debian-diaspora` (thinking I have nothing to lose). Back then, my **first open-source community was Debian**!
...
![](assets/images/acceptance_gsoc.jpg)
...
![](assets/images/gsoc_mentors.jpg)

**The one where I meet mentors!**

Special thanks to them:
- Hans-Christoph Steiner ([@_hc](https://twitter.com/hansstatus))
- Andrej Shadura ([@andrewsh](https://twitter.com/andrew_shadura))
- Kai-Chung Yan ([@seamlik](https://salsa.debian.org/seamlik))
- Chirayu Desai ([@cdesai](https://twitter.com/_cdesai))
- Saif Abdul Casim ([@m36](https://lk.linkedin.com/in/saif-abdul-cassim))

And the awesome [Debian](https://www.debian.org/) community for accepting me as a Student Developer for this year's GSoC!
